defmodule Discuss.Router do
  ...
  scope "/topics", Discuss do
    pipe_through :browser # Use the default browser stack
		...
		resources "/", TopicController # any request following RESTful conventions will be routed to the TopicController, all routes above are automatically synthesized by Phoenix for us
